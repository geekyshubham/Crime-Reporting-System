  ...
  <thead>
	...
	while($re = $resul->fetch_object())
		...
		{		$area=$re->name;
			  ...
			  $result= $mysqli->query("SELECT*  FROM crime_info where area='$area' and status='1'");
	...
	{ 		
		...
		echo "<td><a href=\"finish.php?id=$res->id\">Finish</a> </td>";	
		echo "<td><a href=\"cancel.php?id=$res->id\">Cancel</a> </td>";
